...
public class Constants {
    ...
    //private static final String[] FONTS = {EMPTY, STREATWEAR_FONT, DITI_SWEET_FONT, GERMANIA_ONE_FONT, SLIMJIM_FONT, VOLATIRE_FONT};

    //flags
    private static final String FOR_WHAT = "forWhat";
    private static final int FOR_LOGO = 0;
    private static final int FOR_TEXT = 1;
