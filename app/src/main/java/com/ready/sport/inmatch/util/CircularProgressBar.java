...
/**
 * Created by Luca Martelloni on 27/08/2017.
 */
...
public class CircularProgressBar extends ProgressBar {
    ...
    public void init(AttributeSet attrs, int style){
        ...
        mTitlePaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "fonts/AvenirLTStd-Light.otf"));
        ...
        mSubtitlePaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "fonts/AvenirLTStd-Light.otf"));
